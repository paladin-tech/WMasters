...
list($ConPerWellLvl) = $infosystem->Execute("SELECT `ConPerWell` FROM `wm_company` WHERE `companyID` = ".$_SESSION['companyid'])->fields;
...
<head>
<title>Con Per Well - WM Digital System</title>
...
<table cellspacing="1" cellpadding="3" bgcolor="#CCCCCC">
  <tr>
    ...
    <td>
      <select name="well_id" id="well_id" onchange="xajax_GetWellInfoConPerWell(this.value)"<?=$readOnly?>>
      	<option value=""></option><?
// Filling combo with data
  ...
  <tr>
      ...
      <td><input type="text" name="flag_requested" id="flag_requested" size="12" readonly="readonly" /> <img src="Calendar-icon.png" style="cursor:pointer" onClick="cal1xx1.select(document.forms[0].flag_requested,'anchor1xx1','yyyy-MM-dd')" name="anchor1xx1" id="anchor1xx1"></td>
  </tr>
  <tr>
    <td>Flag Done</td>
    <td id="tdFlagged">&nbsp;</td>
  ...
  <tr>
    ...
    <td id="tdConstructionCompleted">&nbsp;</td>
  </tr>
  <tr>
    <td>Rig Ready</td>
  ...
  <tr>
      ...
      <td><input type="text" name="roll_back_ready" id="roll_back_ready" size="12" readonly="readonly" /> <img src="Calendar-icon.png" style="cursor:pointer" onClick="cal1xx2.select(document.forms[0].roll_back_ready,'anchor1xx2','yyyy-MM-dd')" name="anchor1xx2" id="anchor1xx2"></td>
  </tr>
  <tr>
     <td>Rolled Back</td>
     <td id="tdRolledBack">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input type="text" name="constructed_not_drilled" id="constructed_not_drilled" size="12" readonly="readonly" /> <img src="Calendar-icon.png" style="cursor:pointer" onClick="cal1xx3.select(document.forms[0].constructed_not_drilled,'anchor1xx3','yyyy-MM-dd')" name="anchor1xx3" id="anchor1xx3"></td>
  </tr>
  <tr>
    ...
    <td><input type="text" name="nill_entry_not_built" id="nill_entry_not_built" size="12" readonly="readonly" /> <img src="Calendar-icon.png" style="cursor:pointer" onClick="cal1xx4.select(document.forms[0].nill_entry_not_built,'anchor1xx4','yyyy-MM-dd')" name="anchor1xx4" id="anchor1xx4"></td>
  </tr>
  <tr>
