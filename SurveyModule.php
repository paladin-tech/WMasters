...
if(isset($_POST['submit'])) {
	...
	$SQL = "UPDATE `wells_construction` SET `flagged` = '{$flagged}', `survey_requested_BASE` = '{$survey_requested_BASE}', `survey_completed_BASE` = '{$survey_completed_BASE}', `gps_north_BASE` = '{$gps_north_BASE}', `gps_east_BASE` = '{$gps_east_BASE}', `GL_BASE` = '{$GL_BASE}', `TOC_BASE` = '{$TOC_BASE}', `instrumentation_comments_BASE` = '{$instrumentation_comments_BASE}', `general_comments_BASE` = '{$general_comments_BASE}', `as_built_completed_BASE` = '{$as_built_completed_BASE}', `final_as_built_BASE` = '{$final_as_built_BASE}', `survey_requested_AS_BUILT` = '{$survey_requested_AS_BUILT}', `survey_completed_AS_BUILT` = '{$survey_completed_AS_BUILT}', `gps_north_AS_BUILT` = '{$gps_north_AS_BUILT}', `gps_east_AS_BUILT` = '{$gps_east_AS_BUILT}', `GL_AS_BUILT` = '{$GL_AS_BUILT}', `TOC_AS_BUILT` = '{$TOC_AS_BUILT}', `instrumentation_comments_AS_BUILT` = '{$instrumentation_comments_AS_BUILT}', `general_comments_AS_BUILT` = '{$general_comments_AS_BUILT}', `as_built_completed_AS_BUILT` = '{$as_built_completed_AS_BUILT}', `final_as_built_AS_BUILT` = '{$final_as_built_AS_BUILT}', `survey_requested_R1` = '{$survey_requested_R1}', `survey_completed_R1` = '{$survey_completed_R1}', `gps_north_R1` = '{$gps_north_R1}', `gps_east_R1` = '{$gps_east_R1}', `GL_R1` = '{$GL_R1}', `TOC_R1` = '{$TOC_R1}', `instrumentation_comments_R1` = '{$instrumentation_comments_R1}', `general_comments_R1` = '{$general_comments_R1}', `as_built_completed_R1` = '{$as_built_completed_R1}', `final_as_built_R1` = '{$final_as_built_R1}', `survey_requested_R2` = '{$survey_requested_R2}', `survey_completed_R2` = '{$survey_completed_R2}', `gps_north_R2` = '{$gps_north_R2}', `gps_east_R2` = '{$gps_east_R2}', `GL_R2` = '{$GL_R2}', `TOC_R2` = '{$TOC_R2}', `instrumentation_comments_R2` = '{$instrumentation_comments_R2}', `general_comments_R2` = '{$general_comments_R2}', `as_built_completed_R2` = '{$as_built_completed_R2}', `final_as_built_R2` = '{$final_as_built_R2}', `survey_requested_R3` = '{$survey_requested_R3}', `survey_completed_R3` = '{$survey_completed_R3}', `gps_north_R3` = '{$gps_north_R3}', `gps_east_R3` = '{$gps_east_R3}', `GL_R3` = '{$GL_R3}', `TOC_R3` = '{$TOC_R3}', `instrumentation_comments_R3` = '{$instrumentation_comments_R3}', `general_comments_R3` = '{$general_comments_R3}', `as_built_completed_R3` = '{$as_built_completed_R3}', `final_as_built_R3` = '{$final_as_built_R3}', `survey_requested_R4` = '{$survey_requested_R4}', `survey_completed_R4` = '{$survey_completed_R4}', `gps_north_R4` = '{$gps_north_R4}', `gps_east_R4` = '{$gps_east_R4}', `GL_R4` = '{$GL_R4}', `TOC_R4` = '{$TOC_R4}', `instrumentation_comments_R4` = '{$instrumentation_comments_R4}', `general_comments_R4` = '{$general_comments_R4}', `as_built_completed_R4` = '{$as_built_completed_R4}', `final_as_built_R4` = '{$final_as_built_R4}' WHERE `well_id` = '{$selWell}'";
	...
	<tr valign="top">
		<td width="300">
			<table cellspacing="1" cellpadding="3" bgcolor="#CCCCCC">
				...
				<tr>
					<td>Flag Done</td>
					<td><input type="text" id="flagged" class="datepicker" name="flagged" value="<?=(isset($well_id))?$flagged:""?>" readonly></td>
				</tr>
				<tr>
		...
		<td>
			<table cellspacing="1" cellpadding="3" bgcolor="#CCCCCC">
				...
				<tr>
					...
					<td><input type="text" id="survey_requested_BASE" class="datepicker" name="survey_requested_BASE" value="<?=(isset($well_id))?$survey_requested_BASE:""?>" readonly></td>
					<td><input type="text" id="survey_requested_AS_BUILT" class="datepicker" name="survey_requested_AS_BUILT" value="<?=(isset($well_id))?$survey_requested_AS_BUILT:""?>" readonly></td>
					<td><input type="text" id="survey_requested_R1" class="datepicker" name="survey_requested_R1" value="<?=(isset($well_id))?$survey_requested_R1:""?>" readonly></td>
					<td><input type="text" id="survey_requested_R2" class="datepicker" name="survey_requested_R2" value="<?=(isset($well_id))?$survey_requested_R2:""?>" readonly></td>
					<td><input type="text" id="survey_requested_R3" class="datepicker" name="survey_requested_R3" value="<?=(isset($well_id))?$survey_requested_R3:""?>" readonly></td>
					<td><input type="text" id="survey_requested_R4" class="datepicker" name="survey_requested_R4" value="<?=(isset($well_id))?$survey_requested_R4:""?>" readonly></td>
				</tr>
				<tr>
