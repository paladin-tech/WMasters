...
$rsConHydro = $infosystem->Execute("SELECT `area`, `source_number`, `water_licence`, `source_ID`, `program_zone`, `location_LSD`, `start_date`, `end_date`, `total_licensed_volume` FROM `con_hydro` WHERE (NOW() BETWEEN `start_date` AND `end_date`) OR (NOW() > `start_date` AND `end_date` = '0000-00-00') ORDER BY `area`, `source_number`");
...
<table cellspacing="1" cellpadding="3" bgcolor="#CCCCCC" width="100%">
	...
	?>
	<tr class="bold">
		<td colspan="8" align="right">Total All Sources</td>
